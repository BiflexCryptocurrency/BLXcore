...
In order to support loading of multiple wallets in blx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blx.cpp.
...
Changes to blx.cpp
----------------------
blx.cpp is the entry point into blx-qt, and as such, will require some minor modifications to provide hooks for
