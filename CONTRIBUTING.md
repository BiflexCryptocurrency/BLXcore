Contributing to BLX Core
============================

The BLX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BLX Core project, and is not to be
confused with overall BLX Network Protocol consensus changes.

Whether a pull request is merged into BLX Core rests with the project merge
...
Patches that change BLX consensus rules are considerably more involved than
...
Where a patch set proposes to change the BLX consensus, it must have been
...
The project leader is the release manager for each BLX Core release.
