...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BLX features */
        {"blx", "masternode", &masternode, true, true, false},
        {"blx", "listmasternodes", &listmasternodes, true, true, false},
        {"blx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blx", "masternodedebug", &masternodedebug, true, true, false},
        {"blx", "startmasternode", &startmasternode, true, true, false},
        {"blx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blx", "mnbudget", &mnbudget, true, true, false},
        {"blx", "preparebudget", &preparebudget, true, true, false},
        {"blx", "submitbudget", &submitbudget, true, true, false},
        {"blx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blx", "checkbudgets", &checkbudgets, true, true, false},
        {"blx", "mnsync", &mnsync, true, true, false},
        {"blx", "spork", &spork, true, true, false},
        {"blx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"blx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blxd, or the -server option to blx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> blx-cli " + methodname + " " + args + "\n";
}
