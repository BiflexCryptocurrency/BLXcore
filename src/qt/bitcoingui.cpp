                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BLX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BLX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BLX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BLX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BLX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BLX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BLX addresses"));
    ...
    showAltmarketAction = new QAction(QIcon(":/icons/maltmarket"), tr("&Altmarkets BLX/BTC"), this);
    ...
    openAction->setStatusTip(tr("Open a BLX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BLX Core help message to get a list with possible BLX command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu* blx = appMenuBar->addMenu(tr("&BLX Info"));
    blx->addAction(showWebsiteAction);
    blx->addAction(showExplorerAction);
    blx->addAction(showGithubAction);
    blx->addSeparator();
    blx->addAction(showAltmarketAction);
    blx->addAction(showStatusAction);
    blx->addAction(showTwitterAction);
    blx->addAction(showMobileAction);
    blx->addAction(showShopAction);
    blx->addAction(showRapidsAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BLX Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString link = "https://biflex.net/";
    QDesktopServices::openUrl(QUrl(link));
}

void BitcoinGUI::ExplorerClicked()
{
    QString link = "https://chain.biflex.net/";
    QDesktopServices::openUrl(QUrl(link));
}

void BitcoinGUI::GithubClicked()
{
    QString link = "https://github.com/BiflexCryptocurrency";
    QDesktopServices::openUrl(QUrl(link));
}

void BitcoinGUI::MobileClicked()
{
    QString link = "https://play.google.com/store/apps/details?id=net.biflexwallet.android";
    QDesktopServices::openUrl(QUrl(link));
}
...
{
    QString link = "https://twitter.com/BLXCoin";
    QDesktopServices::openUrl(QUrl(link));
}
...
{
    QString link = "https://altmarkets.io/trading/blxbtc";
    QDesktopServices::openUrl(QUrl(link));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BLX network", "", count));
}
...
{
    QString strTitle = tr("BLX Core"); // default title
...
/** Creates context menu, its actions, and blxs up all the relevant signals for mouse events. */
