...
RESOURCES += src/qt/blx.qrc src/qt/blx_locale.qrc

TRANSLATIONS += src/qt/locale/blx_bg.ts \
                src/qt/locale/blx_de.ts \
                src/qt/locale/blx_en.ts \
                src/qt/locale/blx_es.ts \
                src/qt/locale/blx_fi.ts \
                src/qt/locale/blx_fr.ts \
                src/qt/locale/blx_it.ts \
                src/qt/locale/blx_ja.ts \
                src/qt/locale/blx_pl.ts \
                src/qt/locale/blx_pt.ts \
                src/qt/locale/blx_ru.ts \
                src/qt/locale/blx_sk.ts \
                src/qt/locale/blx_sv.ts \
                src/qt/locale/blx_vi.ts \
                src/qt/locale/blx_zh_CN.ts \
                src/qt/locale/blx_zh_TW.ts
